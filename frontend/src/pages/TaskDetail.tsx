                ...
                <div className="bg-gradient-to-br from-purple-600 to-indigo-700 text-white py-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center animate-pulse">
                            <div className="h-4 bg-purple-400/50 rounded w-24 mx-auto mb-4"></div>
                            <div className="h-12 bg-purple-400/50 rounded w-64 mx-auto mb-4"></div>
                            <div className="h-6 bg-purple-400/50 rounded w-96 mx-auto"></div>
                        </div>
                    </div>
                </div>
